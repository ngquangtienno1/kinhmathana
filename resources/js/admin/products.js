document.addEventListener('DOMContentLoaded', function () {
        ...
        addAttributeBtn.addEventListener('click', function () {
            ...
            function updateValuesContainer(selectedType, rowIndex) {
                ...
                options.forEach(option => {
                    ...
                    div.innerHTML = `
                        <input type="checkbox" class="form-check-input attribute-value-checkbox" name="attributes[${rowIndex}][values][]" value="${option}" data-index="${rowIndex}">
    ...
    const setVariationsPriceBtn = document.getElementById('set-variations-price'); // Thêm dòng này
    if (setVariationsPriceBtn) setVariationsPriceBtn.style.display = 'block'; // Thêm dòng này

    combinations.forEach((name, idx) => {
        const globalIndex = variationsContainer.getElementsByClassName('variation-row').length;
        const skuPrefix = variableSkuInput.value || 'VAR';
        const row = document.createElement('div');
