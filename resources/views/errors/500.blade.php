...
<!-- Mirrored from prium.github.io/phoenix/v1.22.0/pages/errors/500.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 May 2025 16:47:54 GMT -->
<!-- Added by HTTrack -->
                ...
                <div class="col-12 col-xl-10 col-xxl-8">
                    <div class="row justify-content-center g-5">
                        <div class="col-12 col-lg-6 text-center order-lg-1"><img class="img-fluid w-lg-100 d-light-none"
                                src="{{ asset('v1/assets/img/spot-illustrations/500-illustration.png') }}"
                                alt="" width="400" /><img class="img-fluid w-md-50 w-lg-100 d-dark-none"
                                src="{{ asset('v1/assets/img/spot-illustrations/dark_500-illustration.png') }}"
                                alt="" width="540" /></div>
                        <div class="col-12 col-lg-6 text-center text-lg-start"><img
                                class="img-fluid mb-6 w-50 w-lg-75 d-dark-none"
                                src="{{ asset('v1/assets/img/spot-illustrations/500.png') }}" alt="" /><img
                                class="img-fluid mb-6 w-50 w-lg-75 d-light-none"
                                src="{{ asset('v1/assets/img/spot-illustrations/dark_500.png') }}" alt="" />
                            <h2 class="text-body-secondary fw-bolder mb-3">Lỗi không xác định!</h2>
                            <p class="text-body mb-5">Nhưng hãy thư giãn! Mèo của chúng tôi ở đây để chơi nhạc cho bạn
                                nghe.</p><a class="btn btn-lg btn-primary" href="{{ route('client.home') }}">Trang
                                chủ</a>
                        </div>
                    </div>
                </div>
