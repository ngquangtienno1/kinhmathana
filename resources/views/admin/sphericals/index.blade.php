...
<div class="mb-9">
    ...
    <div id="sphericals" data-list='{"valueNames":["value","sort_order"],"page":15,"pagination":true}'>
                                ...
                                <td class="align-middle text-end pe-0 ps-4 btn-reveal-trigger">
                                    <div class="btn-reveal-trigger position-static">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end py-2">
                                            <a class="dropdown-item" href="{{ route('admin.sphericals.edit', $spherical->id) }}">Sửa</a>
            ...
            <div class="row align-items-center justify-content-between py-2 pe-0 fs-9">
                <div class="col-auto d-flex">
                    <p class="mb-0 d-none d-sm-block me-3 fw-semibold text-body" data-list-info="data-list-info">
                        Hiển thị {{ $sphericals->firstItem() }} đến {{ $sphericals->lastItem() }} trong tổng số
                        {{ $sphericals->total() }} Độ cận
                    </p>
