...
<div class="mb-9">
    <div class="row g-3 mb-4">
        <div class="col-auto">
            <h2 class="mb-0">Danh sách độ loạn</h2>
        </div>
    </div>
    ...
    <div id="cylindricals" data-list='{"valueNames":["value","sort_order"],"page":10,"pagination":true}'>
                        ...
                        <tr>
                            <th class="white-space-nowrap fs-9 align-middle ps-0" style="max-width:20px; width:18px;">
                                <div class="form-check mb-0 fs-8">
                                    <input class="form-check-input" id="checkbox-bulk-cylindricals-select"
                                        type="checkbox" data-bulk-select='{"body":"cylindricals-table-body"}' />
                                </div>
                            </th>
                                    ...
                                    <div class="btn-reveal-trigger position-static">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end py-2">
                                            <a class="dropdown-item"
                                                href="{{ route('admin.cylindricals.edit', $cylindrical->id) }}">Sửa</a>
