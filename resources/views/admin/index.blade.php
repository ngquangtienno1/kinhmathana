    ...
    const summaryBarChart = new Chart(document.getElementById('summaryBarChart').getContext('2d'), {
        ...
        data: {
            ...
            datasets: [{
                label: 'Số lượng',
                data: [
                    {{ $promotionProducts }}, {{ $neverOrderedCustomers }}, {{ $mostReviewedProductCount }}, {{ $newCommentsThisWeek }},
                    {{ $totalVariations }}, {{ $lowStockVariations }}, {{ $totalBrands }}, {{ $totalCategories }}
                ],
                backgroundColor: [
                    '#f5a623', '#3874ff', '#e74c3c', '#39f', '#00d27a', '#e63757', '#6c5ce7', '#00b894'
                ],
                borderRadius: 8,
                maxBarThickness: 38
            }]
        ...
        options: {
            ...
            scales: {
                x: {
                    beginAtZero: true,
                    grid: { color: 'rgba(0,0,0,0.05)' },
                    ticks: { color: '#12263f', font: { weight: 600 } }
                },
                y: {
                    grid: { display: false },
                    ticks: { color: '#12263f', font: { weight: 600 } }
