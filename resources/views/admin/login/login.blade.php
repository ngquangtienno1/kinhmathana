...
<!-- Mirrored from prium.github.io/phoenix/v1.22.0/pages/authentication/card/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 May 2025 16:48:00 GMT -->
<!-- Added by HTTrack -->
...
<body>
    ...
    <div class="card-body pe-md-0">
        <div class="row align-items-center gx-0 gy-7">
            <!-- Phần bên trái giữ nguyên (logo, mô tả) -->
                ...
                <div class="auth-form-box">
                    ...
                    <form action="{{ route('postLogin') }}" method="POST">
                        ...
                        <button type="button" class="btn btn-phoenix-secondary w-100">
                            <span class="fab fa-facebook text-primary me-2 fs-9"></span>Đăng nhập bằng facebook
                        </button>
                        ...
                        <div class="mb-3 text-start">
                            ...
                            <div class="form-icon-container">
                                <input class="form-control form-icon-input" id="email" name="email" type="email" placeholder="Hãy nhập email" />
                        ...
                        <div class="mb-3 text-start">
                            ...
                            <div class="form-icon-container" data-password="data-password">
                                <input class="form-control form-icon-input pe-6" id="password" name="password" type="password" placeholder="Mật khẩu" data-password-input="data-password-input" />
...
<!-- Mirrored from prium.github.io/phoenix/v1.22.0/pages/authentication/card/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 May 2025 16:48:02 GMT -->
