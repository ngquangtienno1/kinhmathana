    ...
    <main class="main" id="top">
        <div class="container-fluid bg-body-tertiary dark__bg-gray-1200">
            <div class="bg-holder bg-auth-card-overlay"
                style="background-image:url({{ asset('v1/assets/img/bg/37.png') }});">
            </div>
            <!--/.bg-holder-->
                                ...
                                <div class="col mx-auto">
                                    <div class="auth-form-box">
                                        ...
                                        <form action="{{ route('postRegister') }}" method="post">
                                            @csrf
                                            <div class="mb-3 text-start"><label class="form-label" for="name">Họ
                                                    và tên</label>
                                            ...
                                            <div class="row g-3 mb-3">
                                                ...
                                                <div class="mb-3 text-start"><label class="form-label"
                                                        for="confirmPassword">Xác nhận mật
                                                        khẩu</label>
                                                    <div class="position-relative" data-password="data-password">
                                                        <input class="form-control form-icon-input pe-6"
                                            ...
                                            <div class="form-check mb-3">
                                                ...
                                                <label class="form-label fs-9 text-transform-none"
                                                    for="termsService">Tôi
                                                    chấp nhận <a href="#!">các điều khoản </a>và <a
                                                        href="#!">chính sách bảo mật</a>
                                                </label>
                                            </div>
                                            <button class="btn btn-primary w-100 mb-3" id="registerBtn" disabled>Đăng
                                                ký</button>
