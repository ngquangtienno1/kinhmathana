                ...
                <table class="table fs-9 mb-0 border-top border-translucent">
                    <thead>
                        <tr>
                            ...
                            <th class="white-space-nowrap align-middle" scope="col" style="min-width:400px;">SẢN PHẨM</th>
                            <th class="align-middle text-end ps-4" scope="col" style="width:150px;">GIÁ</th>
                            <th class="align-middle text-end ps-4" scope="col" style="width:100px;">SỐ LƯỢNG</th>
                            <th class="align-middle text-end ps-4" scope="col" style="width:150px;">TỔNG</th>
                        </tr>
                    </thead>
                    <tbody>
                        @if($order->items && count($order->items) > 0)
                            ...
                            <tr>
                                <td class="align-middle white-space-nowrap py-2">
                                    ...
                                    <img src="{{ asset($item->product->thumbnail) }}" alt="" width="53" class="rounded">
                                    @endif
                                </td>
                                ...
                                <td class="align-middle text-end ps-4">{{ number_format($item->price) }}đ</td>
                                <td class="align-middle text-end ps-4">{{ $item->quantity }}</td>
                                <td class="align-middle text-end ps-4 fw-bold">{{ number_format($item->subtotal) }}đ</td>
                            </tr>
                            @endforeach
                        @else
                            <tr>
        ...
        <div class="col-12 col-xl-4 col-xxl-3">
            ...
            <!-- Cập nhật trạng thái -->
                    ...
                    <form action="{{ route('admin.orders.update-status', $order->id) }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary w-100" {{ $order->status == 'cancelled' ? 'disabled' : '' }}>
                            Cập nhật trạng thái
                        </button>
                    </form>
                </div>
