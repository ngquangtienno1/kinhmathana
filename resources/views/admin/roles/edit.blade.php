                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" id="name" name="name"
                                    type="text" value="{{ old('name', $role->name) }}" placeholder="Nhập tên vai trò..."
                                    required />
                            </div>
                            @error('name')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
        ...
        <div class="col-lg-6">
            <div class="card h-100 border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            <button type="button" class="btn btn-outline-primary btn-sm w-100" id="selectAll" @if
                                ($isCustomerRole) disabled @endif>
                                <i class="fas fa-check-square me-1"></i>Chọn tất cả
                            </button>
                        </div>
                        <div class="col-6">
                            <button type="button" class="btn btn-outline-secondary btn-sm w-100" id="deselectAll" @if
                                ($isCustomerRole) disabled @endif>
                                <i class="fas fa-square me-1"></i>Bỏ chọn tất cả
                            </button>
                        </div>
                        ...
                        <div class="permission-group mb-3">
                            <div class="d-flex align-items-center mb-2 p-2 bg-light rounded">
                                <div class="form-check mb-0">
                                    <input type="checkbox" class="form-check-input group-selector"
                                        data-group="{{ Str::slug($group ?: 'khac') }}"
                                        id="group-{{ Str::slug($group ?: 'khac') }}" @if ($isCustomerRole) disabled
                                        @endif>
                                    <label class="form-check-label fw-semibold mb-0"
                                        for="group-{{ Str::slug($group ?: 'khac') }}">
                                        {{ $group ?: 'Quyền khác' }}
