    ...
    <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <ul class="nav nav-tabs mb-3" id="settingsTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="general-tab" data-bs-toggle="tab" data-bs-target="#general" type="button" role="tab" aria-controls="general" aria-selected="true">Thông tin chung</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="shipping-tab" data-bs-toggle="tab" data-bs-target="#shipping" type="button" role="tab" aria-controls="shipping" aria-selected="false">Cấu hình vận chuyển</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="email-tab" data-bs-toggle="tab" data-bs-target="#email" type="button" role="tab" aria-controls="email" aria-selected="false">Cấu hình email</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="ai-tab" data-bs-toggle="tab" data-bs-target="#ai" type="button" role="tab" aria-controls="ai" aria-selected="false">Cấu hình AI</button>
            </li>
        </ul>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="hotline" name="hotline" value="{{ old('hotline', $settings->hotline ?? '') }}" required>
                        </div>
                        <div class="form-group mb-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" class="form-control" id="default_shipping_fee" name="default_shipping_fee" value="{{ old('default_shipping_fee', $settings->default_shipping_fee ?? 0) }}" min="0" required>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="smtp_port" name="smtp_port" value="{{ old('smtp_port', $settings->smtp_port ?? '') }}">
                        </div>
                        <div class="form-group mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control" id="enable_ai_recommendation" name="enable_ai_recommendation">
                                <option value="0" {{ old('enable_ai_recommendation', $settings->enable_ai_recommendation ?? 0) == 0 ? 'selected' : '' }}>Tắt</option>
                                <option value="1" {{ old('enable_ai_recommendation', $settings->enable_ai_recommendation ?? 0) == 1 ? 'selected' : '' }}>Bật</option>
                            </select>
                        </div>
                        <div class="form-group mb-3">
                            <label for="ai_api_key">AI API Key</label>
                            <input type="text" class="form-control" id="ai_api_key" name="ai_api_key" value="{{ old('ai_api_key', $settings->ai_api_key ?? '') }}">
                        </div>
                        <div class="form-group mb-3">
                            <label for="ai_api_endpoint">AI API Endpoint</label>
                            <input type="text" class="form-control" id="ai_api_endpoint" name="ai_api_endpoint" value="{{ old('ai_api_endpoint', $settings->ai_api_endpoint ?? '') }}">
                        </div>
                    </div>
                </div>
            </div>
