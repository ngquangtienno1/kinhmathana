    ...
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1"
        ...
        <div class="offcanvas-header align-items-start border-bottom flex-admin.components.column border-translucent">
            ...
            </div><button class="btn btn-phoenix-admin.components.secondary w-100" data-theme-control="reset"><span
        ...
        <div class="offcanvas-body scrollbar px-admin.components.card" id="themeController">
            ...
            <div class="setting-panel-item">
                ...
                href="https://themes.getbootstrap.com/product/phoenix-admin.components.admin-dashboard-webapp-template/"
