        ...
        <div class="col-12 col-xl-8">
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code', $code ?? '') }}" required placeholder="Nhập mã khuyến mãi">
                    <a href="{{ route('admin.promotions.generate-code') }}" class="btn btn-phoenix-secondary">Tạo mã</a>
                </div>
                @error('code')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
