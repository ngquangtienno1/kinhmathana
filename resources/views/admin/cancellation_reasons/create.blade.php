...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active">Thêm lý do hủy</li>
@endsection

<div class="mb-9">
    <div class="row g-3 mb-4">
        <div class="col-auto">
            <h2 class="mb-0">Thêm lý do hủy</h2>
        </div>
    </div>
    <div class="row g-0">
                    ...
                    <form action="{{ route('admin.cancellation_reasons.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" id="type"
                                ...
                                <option value="customer" {{ old('type') == 'customer' ? 'selected' : '' }}>Khách hàng
                                </option>
