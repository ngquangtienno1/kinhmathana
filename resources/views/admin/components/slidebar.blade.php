                ...
                <div class="nav-item-wrapper">
                    ...
                    <div class="parent-wrapper label-1">
                        <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-products">
                           ...
                           <li class="nav-item">
    <div class="nav-item-wrapper">
        <a class="nav-link dropdown-indicator label-1" href="#nv-attributes" role="button"
            data-bs-toggle="collapse" aria-expanded="{{ request()->is('admin/colors*') || request()->is('admin/sizes*') ? 'true' : 'false' }}"
