...
<div class="mb-9">
    ...
    <div id="orderStatusHistoryTable" data-list='{"valueNames":["order_code","customer","old_status","new_status","updated_at","updated_by"],"page":10,"pagination":true}'>
        <div class="mb-4">
                    ...
                    <div class="search-box">
                        <form class="position-relative">
                            <input class="form-control search-input search" type="search" name="search"
                                id="order-status-history-search-input" placeholder="Nhập mã đơn hàng hoặc tên khách hàng"
                ...
                <table class="table table-sm fs-9 mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="sort align-middle text-center px-3" scope="col" data-sort="order_code" style="width:90px;">Mã đơn hàng</th>
                            <th class="sort align-middle text-center px-3" scope="col" data-sort="customer" style="width:180px;">Khách hàng</th>
                            <th class="sort align-middle text-center px-3" scope="col" data-sort="old_status" style="width:150px;">Trạng thái cũ</th>
                            <th class="sort align-middle text-center px-3" scope="col" data-sort="new_status" style="width:150px;">Trạng thái mới</th>
                            <th class="sort align-middle text-center px-3" scope="col" data-sort="updated_at" style="width:120px;">Thời gian cập nhật</th>
                            <th class="sort align-middle text-center px-3" scope="col" data-sort="updated_by" style="width:130px;">Cập nhật bởi</th>
                        </tr>
                    </thead>
                    <tbody class="list" id="order-status-histories-table-body">
                        @forelse ($histories as $history)
                            <tr>
                                ...
                                <td class="new_status align-middle text-center white-space-nowrap fw-bold text-body-tertiary px-3">
                                    @php
