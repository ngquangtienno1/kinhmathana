...
<form class="mb-9">
    <div class="row g-3 flex-between-end mb-5">
        ...
        <div class="col-auto"><button class="btn btn-phoenix-secondary me-2 mb-2 mb-sm-0"
                ...
                type="button">Save draft</button><button class="btn btn-primary mb-2 mb-sm-0" type="submit">Publish
                product</button></div>
    </div>
    <div class="row g-5">
                ...
                <div class="col-sm-4">
                    <div class="nav flex-sm-column border-bottom border-bottom-sm-0 border-end-sm fs-9 vertical-tab h-100 justify-content-between"
                        role="tablist" aria-orientation="vertical"><a
                            ...
                            aria-controls="productsTabContent" aria-selected="false"> <span
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="ps-4">
                                            <p class="text-body-secondary fs-9 mb-0">You’ll be responsible for product
                                                delivery. <br />Any damage or delay during shipping may cost you a
                                                Damage fee.</p>
                                        </div>
                                    </div>
                                    <div class="mb-4">
