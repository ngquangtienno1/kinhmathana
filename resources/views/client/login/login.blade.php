            ...
            <div class="row flex-center min-vh-100 py-5">
                <div class="col-sm-10 col-md-8 col-lg-5 col-xl-5 col-xxl-3">
                        ...
                        <div class="mb-3 text-start">
                            ...
                            <div class="form-icon-container">
                                <input class="form-control form-icon-input " id="email" name="email" type="email"
                                    placeholder="Hãy nhập email" value="{{ old('email') }}" />
                        ...
                        <div class="mb-3 text-start">
                            ...
                            <div class="form-icon-container position-relative" data-password="data-password">
                                <input class="form-control form-icon-input pe-6 " id="password" name="password"
                                    type="password" placeholder="Mật khẩu" data-password-input="data-password-input" />
                            ...
                            <div class="col-auto">
                                <div class="form-check mb-0">
                                    <input class="form-check-input" id="basic-checkbox" type="checkbox"
                                        checked="checked" />
                                    <label class="form-check-label mb-0" for="basic-checkbox">Ghi nhớ tôi</label>
                                </div>
                            </div>
                    ...
                    <div class="text-center">
                        <a class="fs-9 fw-bold" href="{{ asset('sign-up.html') }}">Tạo tài khoản</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body chat p-0">
                        <div class="d-flex flex-column-reverse scrollbar h-100 p-3">
                            <div class="text-end mt-6">
                                ...
                                <a class="mb-2 d-inline-flex align-items-center text-decoration-none text-body-emphasis bg-body-hover rounded-pill border border-primary py-2 ps-4 pe-3"
                                    href="#!">
                                    <p class="mb-0 fw-semibold fs-9">Tôi không thể đặt lại một sản phẩm tôi đã đặt trước
                                        đó</p>
                                    <span class="fa-solid fa-paper-plane text-primary fs-9 ms-3"></span>
                                </a>
                                <a class="mb-2 d-inline-flex align-items-center text-decoration-none text-body-emphasis bg-body-hover rounded-pill border border-primary py-2 ps-4 pe-3"
