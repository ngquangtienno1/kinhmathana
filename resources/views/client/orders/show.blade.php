        ...
        <div class="order-progress-steps d-flex align-items-center">
            ...
            <div class="order-step text-center flex-fill {{ $i <= $currentIndex ? 'completed' : '' }}">
                <div class="order-step-circle mx-auto mb-1">
                    @if ($i < $currentIndex || ($i==$currentIndex && $step['key']==='completed' )) <span
            ...
            @if ($i < count($steps) - 1) <div class="order-step-line flex-grow-1
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-sm btn-outline-primary btn-review"
                            data-item-id="{{ $item->id }}" data-product-name="{{ $item->product_name }}"
                            data-product-img="{{ $imagePath }}" data-product-options='@json($item->product_options)'
                            data-product-variant="{{ $variantText }}" data-order-id="{{ $order->id }}"
...
<div class="card mb-4">
    <div class="card-body">
        ...
        <div class="alert alert-warning mt-3" role="alert">
            Vui lòng thanh toán <span class="text-danger fw-bold">{{ number_format($order->total_amount, 0, ',', '.')
                }}₫</span> khi
            nhận hàng.
        </div>
        <div class="mt-2">
                    ...
                    <div class="border p-3 rounded-0" style="background: #fff;">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="star-rating" class="mb-1">
                                @for ($i = 1; $i <= 5; $i++) <span class="star fs-3" data-value="{{ $i }}">
                                    &#9733;</span>
                                    @endfor
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="content" id="content" class="form-control rounded-0" rows="4"
                                maxlength="1000" oninput="updateCharCount()" required></textarea>
            ...
            <form id="cancel-order-form" method="POST" action="">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="cancellation_reason_id" id="cancellation_reason_id" required
                            style="font-family: inherit; color: #222; border-radius: 6px;">
                    ...
                    <div class="mb-3" id="other-reason-group" style="display:none;">
                        ...
                        <input type="text" class="form-control" name="other_reason" id="other_reason" maxlength="255"
                            style="font-family: inherit; border-radius: 6px;">
                    </div>
                </div>
                <div class="modal-footer">
