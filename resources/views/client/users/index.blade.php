        ...
        <div class="account-sidebar">
            ...
            <nav class="account-menu">
                <ul>
                    ...
                    <li>@include('client.components.icons.user')<a href="{{ route('client.users.information') }}">Thông tin tài
                            khoản</a></li>
                    <li>@include('client.components.icons.map') <a href="#">Thông tin địa chỉ</a></li>
                    <li>@include('client.components.icons.wallet')<a href="{{ route('client.orders.index') }}">Đơn hàng của tôi</a></li>
                                ...
                                <td>
                                    <div class="action-group">
                                        <a href="#" class="view-order-detail btn-action"
                                            data-order='@json($order)' title="Xem chi tiết"><i
                                                class="fas fa-eye"></i> Xem</a>
                                        @if ($order->status === 'pending')
                                            <button class="cancel-order-btn btn-action btn-cancel"
                                                data-id="{{ $order->id }}" title="Hủy đơn"><i
                                                    class="fas fa-times-circle"></i> Hủy</button>
                                        @endif
                                    </div>
                                </td>
                            </tr>
