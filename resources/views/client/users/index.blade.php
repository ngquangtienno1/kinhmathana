    ...
    <div class="account-sidebar">
        ...
        <nav class="account-menu">
            <ul>
                ...
                <li>@include('client.components.icons.user')<a href="{{ route('client.users.information') }}">Thông tin
                        tài khoản</a></li>
    ...
    <div class="account-content">
                    ...
                    <td>
                        <div class="action-group">
                            ...
                            <button class="cancel-order-btn btn-action btn-cancel" data-id="{{ $order->id }}"
                                title="Hủy đơn"><i class="fas fa-times-circle"></i> Hủy</button>
                            @endif
                        </div>
                    </td>
                </tr>
            ...
            <div
                ...
                <div style="text-align:right;">
                    ...
                    <button id="confirmCancelOrder"
                        style="background:#1ccfcf;color:#fff;padding:6px 18px;border:none;border-radius:4px;">Xác
                        nhận</button>
                </div>
            </div>
        </div>
        <script>
            ...
            btn.addEventListener('click', function(e) {
                ...
                fetch(`/client/users/order-detail/${orderId}`)
                    .then(res => res.json())
                    .then(order => {
