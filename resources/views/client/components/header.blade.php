                ...
                <div class="row gx-0 gy-2 w-100 flex-between-center">
                    <div class="col-auto"><a class="text-decoration-none" href="/">
                            <div class="d-flex align-items-center"><img
                                    src="{{ asset('v1/assets/img/icons/logo.png') }}" alt="phoenix" width="27" />
                    ...
                    <div class="col-auto order-md-1">
                        <ul class="navbar-nav navbar-nav-icons flex-row me-n2">
                            ...
                            <li class="nav-item"><a class="nav-link px-2 icon-indicator icon-indicator-primary"
                                    href="{{ url('cart') }}" role="button"><span class="text-body-tertiary"
            ...
            <div class="dropdown-menu border border-translucent py-0 category-dropdown-menu">
                <div class="card border-0 scrollbar" style="max-height: 657px;">
                    <div class="card-body p-6 pb-3">
                        ...
                        <div class="text-center border-top border-translucent pt-3"><a class="fw-bold" href="#!">See all
