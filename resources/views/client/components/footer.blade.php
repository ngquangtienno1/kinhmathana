<footer id="qodef-page-footer" role="contentinfo">
    <div id="qodef-page-footer-top-area">
        <div id="qodef-page-footer-top-area-inner" class="qodef-content-grid">
            <div
                class="qodef-grid qodef-layout--columns qodef-responsive--custom qodef-col-num--4 qodef-col-num--1024--2 qodef-col-num--768--2 qodef-col-num--680--1 qodef-col-num--480--1 qodef-gutter--normal qodef-skin--light">
                <div class="qodef-grid-inner clear">
                    <div class="qodef-grid-item">
                        <div class="widget widget_block widget_media_image" data-area="footer-top-column-1-home-4">
                            <figure class="wp-block-image size-full"><a href="{{route('client.home')}}"><img loading="lazy"
                                        loading="lazy" decoding="async" width="188" height="89"
                                        src="{{asset('v1/wp-content/uploads/2021/08/logo-footer-light-img-1.png')}}" alt=""
                                        class="wp-image-6566" /></a></figure>
                        </div>
                    </div>
                    <div class="qodef-grid-item">
                        <div id="nav_menu-2" class="widget widget_nav_menu" data-area="qodef-footer-top-area-column-2">
                            ...
                            <div class="menu-footer-menu-column-2-container">
                                <ul id="menu-footer-menu-column-2" class="menu">
                                    <li id="menu-item-121"
                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-121"><a
                                            href="../book-an-appointment/index.html">Book eye test</a></li>
                                    <li id="menu-item-122"
                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-122"><a
                                            href="../our-staff/index.html">Vision therapy</a></li>
                                    <li id="menu-item-123"
                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-123"><a
                                            href="../vouchers/index.html">Vouchers</a></li>
                                    <li id="menu-item-124"
                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-124"><a
                                            href="../pricing-plans/index.html">Lenses &#038; prices</a></li>
                                    <li id="menu-item-125"
                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-125"><a
                                            href="../latest-lens-technology/index.html">Eye health</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="menu-footer-menu-column-4-container">
                                <ul id="menu-footer-menu-column-4" class="menu">
                                    ...
                                    <li id="menu-item-6527"
                                        ...
                                        <a href="../product/way-glasses/index.html">Products on sale</a></li>
                                    <li id="menu-item-6952"
                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6952">
                                        <a href="../blog-right-sidebar/index.html">Our news</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <div id="qodef-page-footer-bottom-area">
        <div id="qodef-page-footer-bottom-area-inner" class="qodef-content-grid">
            <div
                class="qodef-grid qodef-layout--columns qodef-responsive--custom qodef-col-num--2 qodef-col-num--680--1 qodef-col-num--480--1 qodef-gutter--huge qodef-alignment--space-between qodef-skin--light">
                <div class="qodef-grid-inner clear">
                    <div class="qodef-grid-item">
                        <div id="neoocular_core_social_icons_group-6"
                            class="widget widget_neoocular_core_social_icons_group"
                        ...
                        <div id="text-2" class="widget widget_text" data-area="qodef-footer-bottom-area-column-2">
                            <div class="textwidget">
                                <div style="font-size:14px">@ 2021 <a href="https://qodeinteractive.com/"
                                        target="_blank" rel="noopener" style="font-size:14px">Qode Interactive</a>,
