...
<div id="ai-chat-container" class="ai-chat-container">
    <div class="ai-chat-wrapper">
                ...
                <div style="max-width: 80%; display: flex; align-items: flex-end; gap: 8px;">
                    ...
                    <div style="display: flex; flex-direction: column; align-items: flex-start;">
                        <span
                            ...
                            <br><br><a href="/client/login" style="color: #007bff; text-decoration: underline;">Đăng nhập
                                ngay</a>
                            @endif
                        </span>
                ...
                <div style="max-width: 80%; display: flex; align-items: flex-end; gap: 8px;">
                    ...
                    <div style="display: flex; flex-direction: column; align-items: flex-start; gap: 8px;">
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 6px;">
                            <button class="quick-question-btn" data-question="Tư vấn chọn kính cho khuôn mặt tròn">Khuôn
                                mặt tròn</button>
                            <button class="quick-question-btn" data-question="Kính mắt phong thủy có tác dụng gì?">Phong
                                thủy</button>
                            <button class="quick-question-btn" data-question="Giá kính mắt khoảng bao nhiêu?">Giá
                                cả</button>
        ...
        <div class="ai-chat-input-area">
            <input class="ai-chat-input" type="text" id="ai-chat-input" placeholder="Nhập câu hỏi về kính mắt..."
                autocomplete="off">
