...
<script src="{{ asset('v1/vendors/dropzone/dropzone-min.js') }}"></script>
<script src="{{ asset('v1/vendors/rater-js/index.js') }}"></script>
<script src="{{ asset('v1/vendors/glightbox/glightbox.min.js') }}"></script>
