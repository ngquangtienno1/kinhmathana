                    ...
                    <div class="qodef-grid-item qodef-page-content-section qodef-col--12">
                        <div class="woocommerce">
                            ...
                            <div id="qodef-woo-page" class="qodef--checkout">
                                        ...
                                        @if(isset($promotions) && $promotions->count())
                                            <div>
                                                ...
                                                @foreach($promotions as $promotion)
                                                    <button type="button" class="btn btn-sm btn-outline-primary use-voucher" data-code="{{ $promotion->code }}">
                                ...
                                <div class="woocommerce-notices-wrapper"></div>
                                <form name="checkout" method="post" class="checkout woocommerce-checkout" action="{{ route('client.cart.checkout') }}" enctype="multipart/form-data" novalidate="novalidate">
                                    @csrf
                                        ...
                                        <table class="shop_table woocommerce-checkout-review-order-table">
                                                ...
                                                <tr class="cart_item">
                                                    <td class="product-name">
                                                        ...
                                                        @if ($item->variation->name)
                                                            <span class="text-muted">({{ $item->variation->name }})</span>
                                                        @endif
                                                    </td>
                                            ...
                                            <tfoot>
                                                <tr class="cart-subtotal">
                                                    <th>Tạm tính</th>
                                                    <td></td>
                                                    <td><span class="woocommerce-Price-amount amount"><bdi>{{ number_format($cartItems->sum(fn($item) => ($item->variation->sale_price ?? $item->variation->price) * $item->quantity), 0, ',', '.') }}₫</bdi></span></td>
                                                </tr>
                                                <tr>
                                                    <th>Giảm giá</th>
                                                    <td></td>
                                                ...
                                                <tr class="order-total">
                                                    <th>Tổng cộng</th>
                                                    <td></td>
                                                    <td><strong><span class="total-amount">{{ number_format($cartItems->sum(fn($item) => ($item->variation->sale_price ?? $item->variation->price) * $item->quantity), 0, ',', '.') }}₫</span></strong></td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
